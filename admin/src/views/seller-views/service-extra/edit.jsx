...
function EditSellerServiceExtra() {
  ...
  const handleSubmit = (body) => {
    return sellerServiceExtraService.update(id, body);
  };
  ...
  return (
    <Card
      ...
      extra={<LanguageList />}
    >
      <SellerServiceExtraForm form={form} onSubmit={handleSubmit} />
    </Card>
  );
}

export default EditSellerServiceExtra;
